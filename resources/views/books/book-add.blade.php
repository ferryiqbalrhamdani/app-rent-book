      ...
      <div class="card-body">
        ...
        <form action="book-add" method="POST" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="book_code" id="book_code" value="{{ old('book_code') }}" placeholder="Enter book's code...">
            <span class="text-danger mt-2">{{ $errors->first('book_code') }}</span>
          </div>
          <div class="mb-3">
            <label for="title" class="form-label">Titile</label>
            <input type="text" class="form-control" name="title" id="title" value="{{ old('title') }}" placeholder="Enter book's tilte...">
