...
Route::middleware('auth')->group(function () {
    ...
    Route::get('books-list', [BookController::class, 'bookList']);
    Route::get('book-add', [BookController::class, 'add']);
    Route::post('book-add', [BookController::class, 'store']);
    Route::get('book-edit/{slug}', [BookController::class, 'edit']);
    Route::post('book-edit/{slug}', [BookController::class, 'update']);
    Route::post('book-rent/{slug}', [BookController::class, 'bookRent']);
    ...
    Route::get('user-active/{slug}', [UserController::class, 'active']);
    Route::get('user-inactive/{slug}', [UserController::class, 'inactived']);
